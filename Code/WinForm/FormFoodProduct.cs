...
namespace WinForm
{
    public partial class FormFoodProduct : Form
    {
        public FormFoodProduct()
        {
            InitializeComponent();
        }
        ...
        private void buttonQuery_Click(object sender, EventArgs e)
        {
            ...
            this.dataGridView1.DataSource = bll.GetListFood(this.textBoxProNO.Text,this.textBoxProName.Text).Tables[0].DefaultView;
        }
