...
namespace WinForm
{
    public partial class FormSportProduct : Form
    {
        public FormSportProduct()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.dataGridView1.DataSource = bll.GetListSport(this.textBoxProNO.Text, this.textBoxProName.Text).Tables[0].DefaultView;
        }
